...
- (void)viewDidLoad {
    ...
    if ([[NSUserDefaults standardUserDefaults] stringForKey:@"id_users"] !=nil) {
        ...
        NSDictionary *parameters = @{@"user[email]":[[NSUserDefaults standardUserDefaults] stringForKey:@"email_users"]
                                     ,@"user[password]":[[NSUserDefaults standardUserDefaults] stringForKey:@"senha_users"]
                                     };
    ...
    [manager POST:@"http://pos-mobile-ios.herokuapp.com/users/sign_in.json"
       parameters:parameters
          success:^(AFHTTPRequestOperation * _Nonnull operation, id  _Nonnull responseObject) {
              ...
              [[NSUserDefaults standardUserDefaults] setValue:self.txtPassword.text forKey:@"senha_users"];
